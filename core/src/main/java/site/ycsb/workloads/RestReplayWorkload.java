 ...
 */
public class RestReplayWorkload extends CoreWorkload {
  ...
  private BufferedReader tracefile; //EBG - 2021-03-04 - Trace file for replay-based evaluations
  ...
  public void init(Properties p) throws WorkloadException {
    ...
    // EBG - 2021-03-04 - Replay traces for REST plugin
  ...
  // EBG - 2021-03-04 - Replay traces for REST plugin
  // Function to read a trace from the tracefile
  public String[] readATrace(){
    String[] trace = null;
    synchronized(this){
      try{
  ...
  private static NumberGenerator getKeyChooser(String requestDistrib, int recordCount, double zipfContant,
    ...
    case "zipfian":
      ...
      break;
    case "latest":
      throw new WorkloadException("Latest request distribution is not supported for RestReplayWorkload.");
    case "hotspot":
  ...
  public void doTransactionRead(DB db) {
    ...
    String[] trace = readATrace();
    String dbkey = trace[0];
    db.read(null, dbkey, null, result);
  }
